...
- 当前正式前端版本为`v104-20260722-2129`（`app.js`的`APP_VERSION`及全部静态资源缓存参数一致）。
...
- 正式Runtime已运行`v104-20260722-2129`，Node PID 30992、Host PID 31916；loopback、LAN和ZeroTier均HTTP 200。正式回收迁移及旧失败任务只读验收通过，发布过程未移动或删除正式媒体；当前队列属于可变化的运行状态，以API为准。

...
- [x] 在设置页实现媒体库清理扫描、分页报告、停止和受控删除
  - 状态：隔离worker/API/浏览器测试通过；正式`PHOTOS_DIR`只读扫描完成，报告jobId`20260714-201722-880b3aae`，正式删除未授权且未执行。功能已集成最新main，前端版本为v86。

- [x] 安全推送正式main并把最新origin/main集成到媒体清理功能分支
  - 状态：正式main与origin/main均为`d18a2f2`；功能分支使用普通merge集成，不rebase、不改写历史，且未合回main。

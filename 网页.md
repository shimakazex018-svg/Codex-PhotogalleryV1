...
> 当前正式版本（2026-07-18）：v101已在48102发布，在现有SHA-256精确查找旁新增标准64位pHash相似查找和手动增量索引控制。设置页`#/__settings/perceptual`显示覆盖、任务进度和512 MiB占用比例；发布后没有自动全量执行，首批1,000张通过后才手工启动10,000张受限批次。
